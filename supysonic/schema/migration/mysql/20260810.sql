...
CREATE INDEX idx_emo_control_retention
...
CREATE INDEX idx_emo_control_dependency_ref
ON emo_playback_control_transaction (
    playback_context_id,
    epoch,
...
CREATE INDEX idx_emo_control_reconciliation_ref
ON emo_playback_control_transaction (
    playback_context_id,
    epoch,
...
CREATE INDEX idx_emo_reconcile_retention
...
CREATE INDEX idx_emo_reconcile_trigger_ref
ON emo_playback_control_reconciliation (
    playback_context_id,
    epoch,
...
CREATE INDEX idx_emo_local_intent_retention
...
CREATE INDEX idx_emo_core_recovery_retention
