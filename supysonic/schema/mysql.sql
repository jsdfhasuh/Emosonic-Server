...
CREATE TABLE IF NOT EXISTS user_recommendation_feedback (
    ...
    updated_at DATETIME NOT NULL,
    deleted_at DATETIME,
    UNIQUE KEY index_user_recommendation_feedback_user_target_scope (user_id, target_type, target_id, scope)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS emo_playback_control_transaction (
    ...
    KEY idx_emo_control_request_generation (
...
CREATE INDEX idx_emo_handoff_provisional_lane
...
CREATE INDEX idx_emo_broadcast_abandon_time
...
CREATE TABLE IF NOT EXISTS emo_permanent_device_decommission (
    ...
    decommissioned_at_ms BIGINT NOT NULL,
    created_at DATETIME NOT NULL,
    updated_at DATETIME NOT NULL,
    UNIQUE(user_name, client_id, device_session_id)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE INDEX idx_emo_permanent_decommission_time
