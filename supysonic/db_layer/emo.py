...
class EmoPlaybackHandoff(_Model):
    ...
    source_device_session_id = CharField(128, null=True)
    source_connection_nonce = CharField(128, null=True)
    source_connection_epoch = IntegerField(null=True)
    target_client_id = CharField(128)
    target_device_session_id = CharField(128, null=True)
    target_connection_nonce = CharField(128, null=True)
    target_connection_epoch = IntegerField(null=True)
    origin_client_id = CharField(128, null=True)
    status = CharField(32)
